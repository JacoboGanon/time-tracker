      ...
      >
        ...
        <div className="rounded-lg border border-stone-800 bg-stone-900/80 p-8 shadow-2xl shadow-black/40 backdrop-blur-sm">
          ...
          <p className="mb-6 text-center text-sm text-stone-500">
            ...
            {emailFromParams ? (
              <span className="text-stone-300">{emailFromParams}</span>
            ) : (
              "your email"
            )}
          ...
          {resent && (
            <div className="mb-4 rounded border border-green-400/20 bg-green-900/20 px-4 py-3 text-sm text-green-400">
          ...
          <button
            ...
            disabled={resending}
            className="flex w-full items-center justify-center rounded border border-stone-700 bg-stone-800/30 px-4 py-2.5 text-sm font-medium text-stone-300 transition-all hover:border-stone-600 hover:bg-stone-800/60 hover:text-stone-100 disabled:opacity-60"
          >
            {resending ? (
              <div
